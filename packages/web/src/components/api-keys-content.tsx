...
export function ApiKeysContent() {
  ...
  return (
    <div className="space-y-6">
          ...
          <section className="space-y-3 rounded-lg border border-border bg-bg p-4">
            ...
            <div className="flex items-center gap-2 rounded border border-border bg-surface p-3">
              ...
              <button
                ...
                className="shrink-0 rounded border border-border bg-bg p-2 text-text-secondary hover:opacity-90"
              >
                {copied ? (
      ...
      {/* Create form */}
      <section className="space-y-3 rounded-lg border border-border bg-bg p-4">
        <h3 className="text-sm font-bold text-text">Create a new key</h3>
        <form onSubmit={handleCreate} className="space-y-3">
          <label className="block">
            ...
            <input
              ...
              className="mt-1 block w-full rounded border border-border bg-surface px-3 py-2 text-sm text-text focus:border-accent focus:outline-none"
            />
      ...
      <section className="space-y-3">
        <h3 className="text-sm font-bold text-text">Your keys</h3>

        {revokeError && (
          <p
            role="alert"
            className="rounded border border-border bg-bg p-3 text-sm text-status-blocked"
          >
            {revokeError}
          </p>
        )}
        ...
        {isLoading ? (
          ...
          <p
            role="alert"
            className="rounded-lg border border-border bg-bg p-4 text-sm text-status-blocked"
          >
            ...
            {keys.map((key) => (
              <li key={key.id} className="flex items-start justify-between gap-3 p-4">
                ...
                <button
                  ...
                  className="shrink-0 rounded border border-border bg-surface p-2 text-text-secondary hover:opacity-90 disabled:opacity-50"
                >
